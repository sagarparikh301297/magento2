...
{
    const XML_PATH_QUICKVIEW_REMOVE_TAB = 'ktpl_quickview/general/remove_product_tab';
    const XML_PATH_QUICKVIEW_REMOVE_ADDTO_COMPARE = 'ktpl_quickview/general/remove_addto_compare';
    const XML_PATH_QUICKVIEW_REMOVE_ADDTO_WISHLIST = 'ktpl_quickview/general/remove_addto_wishlist';
    const XML_PATH_QUICKVIEW_REMOVE_REVIEWS = 'ktpl_quickview/general/remove_reviews';
    const XML_PATH_QUICKVIEW_REMOVE_PRODUCT_RELATED = 'ktpl_quickview/general/remove_product_related';
    const XML_PATH_QUICKVIEW_REMOVE_PRODUCT_UPSELL = 'ktpl_quickview/general/remove_product_upsell';
    const XML_PATH_QUICKVIEW_REMOVE_PRODUCT_INFOR_MAILTO = 'ktpl_quickview/general/remove_product_info_mailto';
    /**
    ...
    protected function quickViewRemove($layout)
    {
        ...
        if ($removeTab == 0) {
            $layout->getUpdate()->addHandle('ktpl_quickview_removeproduct_tab');
        }
        ...
        if ($removeAddToCompare == 0) {
            $layout->getUpdate()->addHandle('ktpl_quickview_remove_addtocompare');
        }
        ...
        if ($removeAddToWishList == 0) {
            $layout->getUpdate()->addHandle('ktpl_quickview_remove_addtowishlist');
        }
        ...
        if ($removeReviews == 0) {
            $layout->getUpdate()->addHandle('ktpl_quickview_remove_reviews');
        }
        ...
        if ($removeProductRelated == 0) {
            $layout->getUpdate()->addHandle('ktpl_quickview_remove_product_related');
        }
        ...
        if ($removeProductUpsell == 0) {
            $layout->getUpdate()->addHandle('ktpl_quickview_remove_product_upsell');
        }
        ...
        if ($removeProductInfoMailto == 0) {
            $layout->getUpdate()->addHandle('ktpl_quickview_remove_product_info_mailto');
        }
    }
}
