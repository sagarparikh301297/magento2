define([
    ...
    $.widget('ktpl.ktpl_beforebodyend', {
        _create: function () {
            ...
            $(document).ready(function() {
                ...
                $(document).on('click','a', function(e){
                    ...
                    if ($(this).attr('data-post')) {
                        ...
                        url = data_url.action + 'product/' + data_url.data.product + '/qty/'+ qty+ '/form_key/'+ from_key + '/uenc/' + data_url.data.uenc + '/ktplquickview/1';
                    }else{
                        url = $(this).attr('href');
    ...
    return $.ktpl.ktpl_beforebodyend;
});
