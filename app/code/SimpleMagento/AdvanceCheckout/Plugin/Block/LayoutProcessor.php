...
namespace SimpleMagento\AdvanceCheckout\Plugin\Block;
...
class LayoutProcessor extends \Magento\Checkout\Block\Checkout\LayoutProcessor
{
    ...
    {
        return [
            'component' => 'SimpleMagento_AdvanceCheckout/js/view/billing-address',
            ...
            'children' => [
                'billingAddressList' => [
                    'component' => 'SimpleMagento_AdvanceCheckout/js/view/billing-address/list',
                    'displayArea' => 'billing-address-list',
                    'template' => 'SimpleMagento_AdvanceCheckout/billing-address/list'
                ],
                'form-fields' => [
